...
mkdir Dynamic_Topography/${dt_model}/Dynamic_topography/${Res}/${model_type}/Scaled_${dt_model}_${scale_factor}
mkdir Dynamic_Topography/${dt_model}_output
mkdir Dynamic_Topography/${dt_model}_output/${scaled}
mkdir Dynamic_Topography/${dt_model}_output/${scaled}Rotated


## Generate DT ages temp file
ls Dynamic_Topography/${dt_model}/Dynamic_topography/${Res}/${model_type}/${dt_model}_${model_type}_dt*.${grid_type} | rev | awk -F"_" '{print $1}' | cut -c 4- | rev | cut -c 3- | sort -n > dt_ages_temp
...
for age in $ages
    do
		...
		gmt4 grdmath Dynamic_Topography/${dt_model}/Dynamic_topography/${Res}/${model_type}/${dt_model}_${model_type}_dt${age}.${grid_type} ${scale_factor} MUL = Dynamic_Topography/${dt_model}/Dynamic_topography/${Res}/${model_type}/Scaled_${dt_model}_${scale_factor}/${dt_model}_${model_type}_Scaled_dt${age}.nc -V
